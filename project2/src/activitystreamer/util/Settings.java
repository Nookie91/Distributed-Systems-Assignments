...
public class Settings
{
    ...
    private static int localSecurePort = 3880;
    ...
    public static int getLocalSecurePort()
	{
		return localSecurePort;
	}

	public static void setLocalSecurePort(int localSecurePort)
	{
		if(localSecurePort<0 || localSecurePort>65535){
			log.error("supplied port "+localSecurePort+" is out of range, using "+getLocalSecurePort());
		}
		else
		{
			Settings.localSecurePort = localSecurePort;
		}
	}
	...
	public static String socketAddress(SSLSocket socket)
	{
		return socket.getInetAddress()+":"+socket.getPort();
	}
